$(function () {
    ...
    var e = {
        series: [{
            name: "KCB Trong ngày",
            data: [114, 223, 110, 219, 229, 319, 422, 519, 412, 227, 419, 435]
        }],
        chart: {
            foreColor: "#9ba7b2",
            height: 310,
        ...
        xaxis: {
            type: "text",
            categories: ["1/11/2021", "2/11/2021", "3/11/2021", "4/11/2021", "5/11/2021", "6/11/2021", "7/11/2021", "8/11/2021", "9/11/2021", "10/11/2021", "11/11/2021", "12/11/2021"]
        },
        title: {
            text: "KCB",
            align: "left",
    ...
    new ApexCharts(document.querySelector("#chart1____"), e).render();
    e = {
        series: [{
            name: "NỘI TRÚ",
    ...
    new ApexCharts(document.querySelector("#chart5"), e).render(), Highcharts.chart("chart6", {
        ...
        title: {
            text: "TỔNG DOANH THU NỘI TRÚ. January, 2020"
        },
        accessibility: {
            announceNewData: {
                enabled: !0
        ...
        yAxis: {
            title: {
                text: "Doanh thu nội trú khoa ra viện"
            }
        },
        legend: {
            enabled: !1
        ...
        title: {
            text: "DOANH THU NGOẠI TRÚ"
        },
        subtitle: {
            text: "Tổng doanh thu theo phòng khám"
        },
        tooltip: {
