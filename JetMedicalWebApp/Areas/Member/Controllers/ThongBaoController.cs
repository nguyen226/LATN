...
namespace JetMedicalWebApp.Areas.Member.Controllers
{
    public class ThongBaoController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            LichSuGuiChienDichViewModels model = (LichSuGuiChienDichViewModels)internalService.KhoiTaoMemberModel(new LichSuGuiChienDichViewModels());
            return View(model);
        }
        ...
        public ActionResult GetList(int? draw, int? start, int? length, string selectedFields, string stringFilter)
        {
            ...
            Session["LichSuGuiChienDich_SelectedFields"] = inData[CommonConstants.StrSelectedFields];
            Session["LichSuGuiChienDich_SortCondition"] = inData[CommonConstants.StrSortedColumnNames];
            Session["LichSuGuiChienDich_Filter"] = filters;

            IEnumerable<LichSuGuiChienDichDto> displayedData = lichSuGuiChienDichService.GetListDataFromViewExposeDto(filters, inData, out outData);
        ...
        public ActionResult XemChiTiet(int id)
        {
            ...
            string selectedFields = "Id, NoiDung ";
            model.LichSuGuiChienDich = lichSuGuiChienDichService.GetByIdExposeDto(id, selectedFields);
