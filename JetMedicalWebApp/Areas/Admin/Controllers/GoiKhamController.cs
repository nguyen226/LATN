...
namespace JetMedicalWebApp.Areas.Admin.Controllers
{
    ...
    public class GoiKhamController : Controller
    {
        ...
        public ActionResult Update(int? id)
        {
            ...
            if (id != null)
            {
                selectedFields = "id, code, keywords, ActivePhone,descriptions,priceSale, priceOld, name,title, categoriId, languageId,";
                selectedFields += "shorttitle, position,isactive,ishot, approved,avatar, Tags, description, created_at";
