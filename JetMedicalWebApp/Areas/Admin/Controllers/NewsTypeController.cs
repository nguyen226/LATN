...
namespace JetMedicalWebApp.Areas.Admin.Controllers
{
    ...
    public class NewsTypeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            NewsTypeViewModels model = (NewsTypeViewModels)internalService.KhoiTaoModel(new NewsTypeViewModels());
            return View(model);
        }
        ...
        public ActionResult GetList(int? draw, int? start, int? length, string selectedFields, string stringFilter)
        {
            ...
            Session["NewsType_SelectedFields"] = inData[CommonConstants.StrSelectedFields];
            Session["NewsType_SortCondition"] = inData[CommonConstants.StrSortedColumnNames];
            Session["NewsType_Filter"] = filters;

            IEnumerable<NewsTypeDto> displayedData = newsTypeService.GetListExposeDto(filters, inData, out outData);
        ...
        [HttpPost]
        public ActionResult AddOrUpdate(List<NewsTypeDto> listItem)
        {
            string resultMessage = string.Empty;
            Dictionary<string, string> updatedValues = new Dictionary<string, string>();

            resultMessage = newsTypeService.AddOrUpdate(listItem);
        ...
        public ActionResult AddOrUpdateList(int id, List<string> fields, List<string> values)
        {
            ...
            resultMessage = newsTypeService.UpdateByIds(updatedData);
        ...
        public ActionResult DeleteByIds(List<int> ids)
        {
            ...
            if (ids.Count() > 0)
            {
                resultMessage = newsTypeService.DeleteByIds(ids);
            }
            return Json(resultMessage, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult Filter(string selectedFields, string stringFilter, string sortCondition, string top)
        {
            ...
            return Json(newsTypeService.GetListExposeDto(parameters[CommonConstants.StrFilters], (Dictionary<string, string>)parameters[CommonConstants.StrInData], out outData), JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult GetListByCode(string code, string selectedFields)
        {
            ...
            filters = parameters[CommonConstants.StrFilters];
            IEnumerable<NewsTypeDto> displayedData = newsTypeService.GetListExposeDto(filters, inData, out outData);
            return Json(newsTypeService.GetListExposeDto(filters, inData, out outData), JsonRequestBehavior.AllowGet);
        }
