...
namespace JetMedicalWebApp.Areas.Admin.Controllers
{
    ...
    public class DepartmentController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            DepartmentViewModels model = (DepartmentViewModels)internalService.KhoiTaoModel(new DepartmentViewModels());
            return View(model);
        }
        ...
        public ActionResult GetList(int? draw, int? start, int? length, string selectedFields, string stringFilter)
        {
            ...
            Session["Department_SelectedFields"] = inData[CommonConstants.StrSelectedFields];
            Session["Department_SortCondition"] = inData[CommonConstants.StrSortedColumnNames];
            Session["Department_Filter"] = filters;

            IEnumerable<DepartmentDto> displayedData = departmentService.GetListExposeDto(filters, inData, out outData);
        ...
        public ActionResult AddOrUpdate(string id, List<string> fields, List<string> values)
        {
            ...
            resultMessage = departmentService.AddOrUpdate(id, updatedValues);
        ...
        public ActionResult DeleteByIds(List<int> ids)
        {
            ...
            if (ids.Count() > 0)
            {
                resultMessage = departmentService.DeleteByIds(ids);
            }
            return Json(resultMessage, JsonRequestBehavior.AllowGet);
        }
