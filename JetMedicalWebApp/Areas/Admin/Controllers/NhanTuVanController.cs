...
namespace JetMedicalWebApp.Areas.Admin.Controllers
{
    ...
    public class NhanTuVanController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            NhanTuVanViewModels model = (NhanTuVanViewModels)internalService.KhoiTaoModel(new NhanTuVanViewModels());
            return View(model);
        }
        ...
        public ActionResult Filter(string selectedFields, string stringFilter, string sortCondition, string top)
        {
            ...
            return Json(nhanTuVanService.GetListExposeDto(parameters[CommonConstants.StrFilters], (Dictionary<string, string>)parameters[CommonConstants.StrInData], out outData), JsonRequestBehavior.AllowGet);
        }
    }
}