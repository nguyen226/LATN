...
{
    public class KSK_XNCTMController : Controller
    {
        ...
        public ActionResult GetList(int? draw, int? start, int? length, string selectedFields, string stringFilter)
        {
            ...
            IEnumerable<KSK_XNCTMDto> displayedData = ksk_xnctmService.GetListTTBNDataFromViewExposeDto(filters, inData, out outData);
