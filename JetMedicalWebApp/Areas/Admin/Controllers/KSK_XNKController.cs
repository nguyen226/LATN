...
{
    public class KSK_XNKController : Controller
    {
        KSK_XNKService ksk_xnctmService = new KSK_XNKService();
        [HttpPost]
        public ActionResult GetList(int? draw, int? start, int? length, string selectedFields, string stringFilter)
        {
            ...
            IEnumerable<KSK_XNKDto> displayedData = ksk_xnctmService.GetListTTBNDataFromViewExposeDto(filters, inData, out outData);
