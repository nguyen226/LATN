...
namespace JetMedicalWebApp.Areas.Admin.Controllers
{
    public class ProvinceController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ProvinceViewModels model = (ProvinceViewModels)internalService.KhoiTaoModel(new ProvinceViewModels());
            return View(model);
        }
        ...
        public ActionResult GetList(int? draw, int? start, int? length, string selectedFields, string stringFilter)
        {
            ...
            IEnumerable<ProvinceDto> displayedData = provinceService.GetListExposeDto(filters, inData, out outData);
        ...
        public ActionResult AddOrUpdate(string id, List<string> fields, List<string> values)
        {
            ...
            resultMessage = provinceService.AddOrUpdate(id, updatedValues);
        ...
        public ActionResult DeleteByIds(List<string> ids)
        {
            ...
            if (ids.Count() > 0)
            {
                resultMessage = provinceService.DeleteByIds(ids);
            }
            return Json(resultMessage, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult Filter(string selectedFields, string stringFilter, string sortCondition, string top)
        {
            ...
            return Json(provinceService.GetListExposeDto(parameters[CommonConstants.StrFilters], (Dictionary<string, string>)parameters[CommonConstants.StrInData], out outData), JsonRequestBehavior.AllowGet);
        }
    }
}