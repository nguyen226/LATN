...
namespace JetMedicalWebApp.Areas.Admin.Controllers
{
    ...
    public class KhoaController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            KhoaViewModels model = (KhoaViewModels)internalService.KhoiTaoModel(new KhoaViewModels());
            return View(model);
        }
        ...
        public ActionResult GetList(int? draw, int? start, int? length, string selectedFields, string stringFilter)
        {
            ...
            Session["Khoa_SelectedFields"] = inData[CommonConstants.StrSelectedFields];
            Session["Khoa_SortCondition"] = inData[CommonConstants.StrSortedColumnNames];
            Session["Khoa_Filter"] = filters;

            IEnumerable<KhoaDto> displayedData = khoaService.GetListExposeDto(filters, inData, out outData);
        ...
        public ActionResult AddOrUpdate(string id, List<string> fields, List<string> values)
        {
            ...
            resultMessage = khoaService.AddOrUpdate(id, updatedValues);
        ...
        public ActionResult DeleteByIds(List<int> ids)
        {
            ...
            if (ids.Count() > 0)
            {
                resultMessage = khoaService.DeleteByIds(ids);
            }
            return Json(resultMessage, JsonRequestBehavior.AllowGet);
        }
