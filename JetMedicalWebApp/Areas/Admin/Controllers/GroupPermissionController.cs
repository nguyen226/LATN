...
namespace JetMedicalWebApp.Areas.Admin.Controllers
{
    public class GroupPermissionController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            GroupPermissionViewModels model = (GroupPermissionViewModels)internalService.KhoiTaoModel(new GroupPermissionViewModels());
            ...
            else
            {
                ...
                string stringFilter = "IsActive = true";
        ...
        public ActionResult GetList(int? draw, int? start, int? length, string selectedFields, string stringFilter)
        {
            ...
            Session["GroupPermission_SelectedFields"] = inData[CommonConstants.StrSelectedFields];
            Session["GroupPermission_SortCondition"] = inData[CommonConstants.StrSortedColumnNames];
            Session["GroupPermission_Filter"] = filters;

            IEnumerable<GroupPermissionDto> displayedData = groupPermissionService.GetListExposeDto(filters, inData, out outData);
        ...
        public ActionResult AddOrUpdate(string id, List<string> fields, List<string> values)
        {
            ...
            resultMessage = groupPermissionService.AddOrUpdate(id, updatedValues);
        ...
        public ActionResult DeleteByIds(List<int> ids)
        {
            ...
            if (ids.Count() > 0)
            {
                resultMessage = groupPermissionService.DeleteByIds(ids);
            }
            return Json(resultMessage, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult Filter(string selectedFields, string stringFilter, string sortCondition, string top)
        {
            ...
            return Json(groupPermissionService.GetListExposeDto(parameters[CommonConstants.StrFilters], (Dictionary<string, string>)parameters[CommonConstants.StrInData], out outData), JsonRequestBehavior.AllowGet);
        }
    }
}