...
namespace JetMedicalWebApp.Areas.Admin.Controllers
{
    ...
    {
        GroupsService nhomNguoiDungService = new GroupsService();

        public ActionResult Index()
        {
            InternalService internalService = new InternalService();
            GroupsViewModels model = (GroupsViewModels)internalService.KhoiTaoModel(new GroupsViewModels());
            return View(model);
        }
        ...
        public ActionResult GetList(int? draw, int? start, int? length, string selectedFields, string stringFilter)
        {
            ...
            IEnumerable<GroupsDto> displayedData = nhomNguoiDungService.GetListExposeDto(filters, inData, out outData);
        ...
        public ActionResult AddOrUpdate(string id, List<string> fields, List<string> values)
        {
            ...
            resultMessage = nhomNguoiDungService.AddOrUpdate(id, updatedValues);
        ...
        public ActionResult DeleteByIds(List<int> ids)
        {
            ...
            if (ids.Count() > 0)
            {
                resultMessage = nhomNguoiDungService.DeleteByIds(ids);
            }
            return Json(resultMessage, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult Filter(string selectedFields, string stringFilter, string sortCondition, string top)
        {
            ...
            return Json(nhomNguoiDungService.GetListExposeDto(parameters[CommonConstants.StrFilters], (Dictionary<string, string>)parameters[CommonConstants.StrInData], out outData), JsonRequestBehavior.AllowGet);
        }
    }
}