...
namespace JetMedicalWebApp.Areas.Admin.Controllers
{
    ...
    {
        ICD10Service iCD10Service = new ICD10Service();

        public ActionResult Index()
        {
            InternalService internalService = new InternalService();
            ICD10ViewModels model = (ICD10ViewModels)internalService.KhoiTaoModel(new ICD10ViewModels());
            return View(model);
        }
        ...
        public ActionResult GetList(int? draw, int? start, int? length, string selectedFields, string stringFilter)
        {
            ...
            IEnumerable<ICD10Dto> displayedData = iCD10Service.GetListExposeDto(filters, inData, out outData);
        ...
        public ActionResult AddOrUpdate(string id, List<string> fields, List<string> values)
        {
            ...
            resultMessage = iCD10Service.AddOrUpdate(id, updatedValues);
        ...
        public ActionResult DeleteByIds(List<int> ids)
        {
            ...
            if (ids.Count() > 0)
            {
                resultMessage = iCD10Service.DeleteByIds(ids);
            }
            return Json(resultMessage, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult Filter(string selectedFields, string stringFilter, string sortCondition, string top)
        {
            ...
            return Json(iCD10Service.GetListExposeDto(parameters[CommonConstants.StrFilters], (Dictionary<string, string>)parameters[CommonConstants.StrInData], out outData), JsonRequestBehavior.AllowGet);
        }
    }
}